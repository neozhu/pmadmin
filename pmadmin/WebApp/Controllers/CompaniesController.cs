...
namespace WebApp.Controllers
{
	public class CompaniesController : Controller
	{
		...
		public async Task<ActionResult> Create([Bind(Include = "Departments,Employee,Id,Name,Logo,Domain,Address,City,Province,RegisterDate")] Company company)
		{
		...
		[HttpPost]
		//[ValidateAntiForgeryToken]
		public async Task<ActionResult> Edit([Bind(Include = "Departments,Employee,Id,Name,Logo,Domain,Address,City,Province,RegisterDate")] Company company)
		{
			if (ModelState.IsValid)
			{
