...
namespace WebApp.Controllers
{
	public class NotificationsController : Controller
	{
		...
		public async Task<ActionResult> Create([Bind(Include = "Id,Title,Type,Message,Link,Status,To,Creator,Created")] Notification notification)
		{
		...
		[HttpPost]
		//[ValidateAntiForgeryToken]
		public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Type,Message,Link,Status,To,Creator,Created")] Notification notification)
		{
			if (ModelState.IsValid)
			{
